...
public class SdkProxy {
	...
	protected void onEnterGame(Map<String, Object> data) {
		...
		//TODO 上报游戏数据接口
		HttpService.enterGame(new ISuccess() {
			@Override
			public void onSuccess(String response) {
				...
				switch (code) {
					case ResultCode.SUCCESS: //成功
						...
						LogUtil.log("=====上报数据成功==="+JSON.parseObject(response));
						break;
					default:
						LogUtil.log("=====上报数据失败==="+JSON.parseObject(response));
						break;
				}
			}
		}, new IError() {
