...
public class SDK {
	...
	public static final class URL{
		...
		public static String REG_URL = "/api/user_reg.php";//注册
		public static String RAND_USER_NAME="/api/rand_user_name.php"; //随机分配用户名接口
		public static String LOGIN_URL ="/api/login_check.php"; //登录
		public static String QUERY_ACCOUNT_BIND ="/api/is_bind_mobile.php"; //查询账号是否绑定手机号
		public static String REG_MOBILE="/api/mobile_reg.php"; //手机注册
		public static String GET_RESURITY_CODE_URL ="/api/send_rand_code.php";//获取手机验证码
		public static String RECORD_ACTIVATE="/api/record_activate.php";//上报设备激活接口
		public static String BIND_MOBILE_URL ="/api/bind_mobile.php"; //绑定手机请求
