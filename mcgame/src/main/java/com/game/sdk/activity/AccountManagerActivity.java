...
//			KnLog.log("账号绑定++");
			...
			HttpService.visitorReg(m_activity,mHandler);
	...
	private static class MyHandler extends Handler{
		...
		private final WeakReference<AccountManagerActivity> mActivity;
		private MyHandler(AccountManagerActivity activity) {
			mActivity = new WeakReference<AccountManagerActivity>(activity);
		}
		@Override
		public void handleMessage(Message msg) {
			AccountManagerActivity activity = mActivity.get();
			if (activity != null) {
